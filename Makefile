...
all: http_parser.o
	$(CC) http-parser/http_parser.o src/utils.c src/buffer.c src/dispatch.c src/static.c src/network.c src/rio.c -O3 -lcrypto -lzmq -lczmq -lmsgpack -std=c99 -o rio -DDEBUG=0
debug:
