...
test:
	gcc http-parser/http_parser.o -g src/utils.c src/dispatch.c src/static.c src/network.c src/tests.c -lzmq -lmsgpack -lcunit -std=c98 -o test_rio -DDEBUG=1 -DTEST=1
	./test_rio
